  ...
  <form @submit.prevent="update">
    <div class="grid grid-cols-6 gap-4">
      <div class="col-span-2">
        ...
        <!--          The v-model directive in Vue.js is a two-way binding directive that creates a -->
        <!--          connection between the data in your Vue instance and the -->
        <!--          , allowing changes in one to automatically reflect in the other and vice versa.-->
        <input v-model.number="form.beds" type="text" class="input" />
        <div v-if="form.errors.beds" class="input-error">
          {{ form.errors.beds }}
          <!-- form.erros used to show validation error hyro7 3la beds fe validation w yshof eih rules bta3etha -->
        </div>
      </div>
